...
<body>
<div align="center"><h2>Pokemon Manager</h2>
    <form method="get" action="search">
        <input type="text" name="keyword"/> &nbsp;
        <input type="submit" value="Search"/>
    </form>
    <h3>
    <a href="${pageContext.request.contextPath}/new">New Pokemon</a></h3>
    <table border="1" cellpadding="5">
        ...
        <c:forEach items="${listPokemon}" var="pokemon">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/edit?id=${pokemon.id}">Edit</a> &nbsp;&nbsp;&nbsp;

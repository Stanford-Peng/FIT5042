...
public interface PokemonRepository extends JpaRepository<Pokemon, Long> {
    ...
    Just declare an interface that extends the CrudRepository interface which defines CRUD methods like save(), findAll(), findById(),deleteById(), etc.
    ...
    JPA/CrudRepository interface EX: CrudRepository<Pokemon, Long> */

...
import helloworld.Loan;

public class WebServiceClient {
	private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://0.0.0.0:8080/w5-war-REST/webresources";
    ...
    public void setPostLoan(double principle, int year, double interestRate) {
    	//Form form = new Form();
    	Loan loan = new Loan(principle,interestRate,year);
    	
    	webTarget.path("loan").request(MediaType.APPLICATION_JSON).post(Entity.json(loan), String.class);

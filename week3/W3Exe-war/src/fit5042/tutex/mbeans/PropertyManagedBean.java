...
@SessionScoped
//@Named(value = "propertyManagedBean")
//@ApplicationScoped
public class PropertyManagedBean implements Serializable {
	
	private Set<Property> allCompareProperty = new LinkedHashSet<Property>();
    ...
    public Set<Property> getAllCompareProperty() {
		return allCompareProperty;
	}

	public void setAllCompareProperty(Set<Property> allCompareProperty) {
		this.allCompareProperty = allCompareProperty;
	}
	...
	public void setCompareProperty(CompareProperty compareProperty) {
    ...
    public PropertyManagedBean() {
        selectedId = 0;
        //allCompareProperty = compareProperty.getList();
